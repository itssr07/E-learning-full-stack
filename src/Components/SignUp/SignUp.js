...
function SignUp() {
  return (
    <div>
      <div className="h-full bg-gradient-to-tl from-white to-white w-full py-16 px-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-white shadow-lg shadow-neutral-300 border border-black shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
            <p
              tabIndex={0}
              role="heading"
